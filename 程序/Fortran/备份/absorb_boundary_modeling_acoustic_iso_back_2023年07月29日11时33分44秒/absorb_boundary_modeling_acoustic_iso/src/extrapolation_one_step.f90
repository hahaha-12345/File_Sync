            ...
            do ix = 1, nx
                ...
                !PML wavefield extrapolation
	                ...
	                sum_x_u_d1 = (coe_1st(1) *                &
	                              ...
	                              coe_1st(2) *                &
	                              (u2(ix+2,iz)-u2(ix-2,iz)) + &
	                              coe_1st(3) *                &
                   	              (u2(ix+3,iz)-u2(ix-3,iz)) + &
	                              coe_1st(4) *                &
                                  (u2(ix+4,iz)-u2(ix-4,iz)) + &
	                              coe_1st(5) *                &
	                              (u2(ix+5,iz)-u2(ix-5,iz))   &
                                 )                            &
                                  / dx
                    ...
                    sum_z_u_d1 = (coe_1st(1) *                &
                                  (u2(ix,iz+1)-u2(ix,iz-1)) + &
                                  coe_1st(2) *                &
                                  (u2(ix,iz+2)-u2(ix,iz-2)) + &
                                  coe_1st(3) *                &
                                  (u2(ix,iz+3)-u2(ix,iz-3)) + &
                                  coe_1st(4) *                &
                                  (u2(ix,iz+4)-u2(ix,iz-4)) + &
                                  coe_1st(5) *                &
                                  (u2(ix,iz+5)-u2(ix,iz-5))   &
                                 )                            &
                                  / dx
